function makeEyetraceSubplots_collapsed(daystats, daycrstats, mouseStart, mouseEnd, group, poweridx, timeVector)
...
while thisMouse <= mouseEnd
    pretestidx = daystats.phase == 1 & daystats.mouse==thisMouse & poweridx(iter);
    if sum(pretestidx)>0
